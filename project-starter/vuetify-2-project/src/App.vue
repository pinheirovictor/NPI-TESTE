            ...
            <v-app-bar color="primary" dark dense app>
              <div class="d-flex align-center">
                ...
                <v-toolbar-items class="ml-3">
                    <v-btn to="/home" text>Início</v-btn>
                    <v-btn to="/register" text>Cadastro</v-btn>
                    <v-btn to="/cursoregister" text>Cadastrar Curso</v-btn>
                    <v-btn to="/mostrarCursos" text>Mostrar Cursos</v-btn>
                    <v-btn to="/alunoregister" text>Cadastrar Aluno ao Curso</v-btn>
                </v-toolbar-items>
